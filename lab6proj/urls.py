...
from lab6app.views import generateCSV, home,registerajax,studentlist,courselist,register,enrolledStudents,add_project,StudentListView,StudentDetailView,generatePDF,enrolledlistajax
urlpatterns = [
    ...
    path('course_search_ajax/',enrolledlistajax),
]
